...
import { ROTATING_WORDS } from './HeroData'
        ...
        <Box sx={{ maxWidth: '100%', textAlign: 'center' }}>
          ...
          <Box sx={{ mb: 0.5 }}>
            <Box
              ...
              alt="T&H Cricket"
              sx={{ height: { xs: 240, md: 320, lg: 380 }, width: 'auto', display: 'block', mx: 'auto', mb: 1.5 }}
            />
            <Typography
              variant="h1"
              sx={{
          ...
          <Typography
            variant="body1"
            sx={{ color: 'rgba(255,255,255,0.62)', mb: 2, fontSize: { xs: '1rem', md: '1.05rem' } }}
          >
