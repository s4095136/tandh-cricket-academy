...
//           <Box
//             component="img"
//             src={'https://tandh-backend-deployment-production.up.railway.app/images/philosophy/hanni.png'}
//             alt=""
//             sx={{
//               position: 'absolute',
//               inset: 0,
  ...
  return (
    <Box
      sx={{
        ...
        display: 'flex',
        flexDirection: { xs: 'column', md: imageSide ? 'row' : 'column' },
      }}
    >
      {/* Mobile top image — only for imageSide layout */}
      {imageSide && (
        <Box
          sx={{
            display: { xs: 'block', md: 'none' },
        ...
        >
          ...
          <Box
            sx={{
              position: 'absolute',
              inset: 0,
              background: 'linear-gradient(to top, rgba(1,13,42,1) 0%, rgba(1,13,42,0.3) 100%)',
            }}
          />
        </Box>
      )}

      {/* Full background image — for non-imageSide layout */}
      {!imageSide && (
        <>
          <Box
            component="img"
      ...
      {/* Desktop right image — only for imageSide layout */}
      {imageSide && (
        <Box
          sx={{
            display: { xs: 'none', md: 'block' },
...
{/* Player Development — full background image */}
<SectionBlock
...
{/* Cricket Excellence — full background image */}
<SectionBlock
